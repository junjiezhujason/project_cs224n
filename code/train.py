...
tf.app.flags.DEFINE_integer("max_question_length", 10, "Maximum question length to consider.")
tf.app.flags.DEFINE_integer("max_context_length", 250, "Maximum context length to consider.")
